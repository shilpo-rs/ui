...
impl Render for CardStory {
    fn render(&mut self, _: &mut Window, _cx: &mut Context<Self>) -> impl IntoElement {
        v_flex()
            .gap_6()
            .child(
                section("Card Variants (Filled, Elevated, Outlined)")
                    .max_w_2xl()
                    .child(
                        h_flex()
                            .gap_4()
                            .child(
                                Card::filled()
                                    .w_64()
                                    .child(
                                        CardHeader::new("Filled Card")
                                            .description("Subtle background contrast."),
                                    )
                                    .child(
                                        div()
                                            .text_sm()
                            ...
                            .child(
                                Card::elevated()
                                    .w_64()
                                    .child(
                                        CardHeader::new("Elevated Card")
                                            .description("Shadow depth elevation."),
                                    )
                                    .child(
                                        div()
                                            .text_sm()
                                            .child("Elevated cards stand out with drop shadows."),
                                    ),
                            )
                            .child(
                                Card::outlined()
                                    .w_64()
                                    .child(
                                        CardHeader::new("Outlined Card")
                                            .description("Clean border stroke."),
                                    )
                                    .child(
                                        div()
                                            .text_sm()
                                            .child("Outlined cards feature a distinct border line."),
                                    ),
                            ),
                    ),
            )
                ...
                section("Interactive Card")
                    ...
                    .child(
                        Card::elevated()
                            ...
                            .on_click(|_, _, _| {})
                            .child(
                                CardHeader::new("Clickable Card")
                                    .description("Hover and press interaction state."),
                            )
                            .child(
                                h_flex()
                                    .items_center()
