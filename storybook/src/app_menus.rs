...
fn build_menus(title: impl Into<SharedString>, cx: &App) -> Vec<Menu> {
    vec![
        ...
        Menu {
            name: "Edit".into(),
            items: vec![
                MenuItem::action("Undo", shilpo_m3e::controls::input::Undo),
                MenuItem::action("Redo", shilpo_m3e::controls::input::Redo),
                MenuItem::separator(),
                MenuItem::action("Cut", shilpo_m3e::controls::input::Cut),
                MenuItem::action("Copy", shilpo_m3e::controls::input::Copy),
                MenuItem::action("Paste", shilpo_m3e::controls::input::Paste),
                MenuItem::separator(),
                MenuItem::action("Delete", shilpo_m3e::controls::input::Delete),
                MenuItem::action(
                ...
                MenuItem::separator(),
                MenuItem::action("Select All", shilpo_m3e::controls::input::SelectAll),
            ],
            disabled: false,
        },
        Menu {
