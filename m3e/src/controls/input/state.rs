...
impl InputState {
    ...
    pub(crate) fn handle_right_click_menu(
        ...
        let menu = if let Some(builder) = self.context_menu_builder.clone() {
            ...
            if is_code_editor {
                menu = menu
                    .menu_with_disabled(
                        ...
                        !has_goto_definition,
                        Box::new(crate::controls::input::GoToDefinition),
                    )
                    .menu_with_disabled(
                        rust_i18n::t!("Input.Show Code Actions"),
                        !has_code_action,
                        Box::new(crate::controls::input::ToggleCodeActions),
                    )
                    .separator();
            }
            ...
            menu.menu_with_disabled(
                ...
                Box::new(crate::controls::input::Cut),
            )
            .menu_with_disabled(
                rust_i18n::t!("Input.Copy"),
                !is_selected,
                Box::new(crate::controls::input::Copy),
            )
            .menu_with_disabled(
                rust_i18n::t!("Input.Paste"),
                !has_paste,
                Box::new(crate::controls::input::Paste),
            )
            .separator()
            .menu(
                rust_i18n::t!("Input.Select All"),
                Box::new(crate::controls::input::SelectAll),
            )
        };
    ...
    fn update_fold_candidates(&mut self) {
        ...
        let fold_ranges = crate::controls::input::display_map::extract_fold_ranges(tree);
            ...
            let result = cx
                ...
                .spawn(async move {
                    ...
                    let fold_ranges = if is_folding {
                        crate::controls::input::display_map::extract_fold_ranges(&new_tree)
                    } else {
                        Vec::new()
                    };
